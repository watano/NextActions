...
function NA10Dps()
  ...
  if(W_IsInCombat())then
	...
	local xrdst2 = W_RetainBuff(NA_Target, -130320, true);   --旭日东升踢的易伤
...
or NA_Fire(true, '123904', NA_Target) --白虎下凡
or NA_Fire(true, '119381', NA_Target) --扫堂腿
or NA_Fire(hlzw==5, '123273', NA_Target) --5层活力下的升腾之雾
or NA_Fire(UnitPower(NA_Player, SPELL_POWER_CHI)>3, '100784', NA_Target) --幻灭踢
or NA_Fire(true, '108557', NA_Target) --贯日击
or NA_Fire(true, '123761', NA_Player) --法力茶
...
local xrdst3 = W_RetainBuff(NA_Target, -107428, true);   --旭日东升踢的易伤
...
or NA_Fire(not xrdst3, '107428', NA_Target) --旭日东升踢
or NA_Fire(UnitPower(NA_Player,3)<60, '113656', NA_Target) --怒雷破
or NA_Fire(true, '107428', NA_Target) --旭日东升踢
or NA_Fire(true, '115098', NA_Player) --真气波
or NA_Fire(UnitPower(NA_Player, SPELL_POWER_CHI)>3, '100784', NA_Target) --幻灭踢
or NA_Fire(nlp, '116740', NA_Player) --虎眼酒
    ...
    elseif(UnitCanAssist(NA_Player, NA_Target) and UnitIsPlayer(NA_Target))then
      if(false
      or NA_Fire(needHP, '112278', NA_Player) --驱不坏
      or NA_Fire(needHP2, '115203', NA_Player) --壮胆酒
or NA_Fire(needHP3, '115072', NA_Player) --移花接木
or NA_Fire(needHP3, '115098', NA_Player) --真气波
      
      )then return true; end
       if(NA_ProfileNo == 1)then --Mistweaver
    ...
    local lls = W_FormInfo(1);   --灵龙式
      if(not NA_IsAOE and (false
      or NA_Fire(not lls, '115070', NA_Player) --灵龙式
      or NA_Fire(W_HPlevel(NA_Target)<0.3, '116849', NA_Target) --作茧缚命
      or NA_Fire(true, '115151', NA_Target) --复苏之雾
or NA_Fire(true, '115072', NA_Player) --移花接木
or NA_Fire(UnitPower(NA_Player, SPELL_POWER_CHI)>3, '116670', NA_Player) --镇魂引
or NA_Fire(true, '115098', NA_Target) --真气波
or NA_Fire(W_HPlevel(NA_Target)<0.8, '101546', NA_Target) --神鹤引颈踢
or NA_Fire(W_HPlevel(NA_Target)<0.7 and fwzw, '116994', NA_Target) --升腾之雾
or NA_Fire(W_HPlevel(NA_Target)<0.7 and fwzw, '124682', NA_Target) --氤氲之雾
or NA_Fire(W_HPlevel(NA_Target)<0.9, '115175', NA_Target) --抚慰之雾
or NA_Fire(W_HPlevel(NA_Target)<0.6, '116994', NA_Target) --升腾之雾
or NA_Fire(W_HPlevel(NA_Target)<0.5, '124682', NA_Target) --氤氲之雾
or NA_Fire(true, '123761', NA_Player) --法力茶
or NA_Fire(true, '116680', NA_Player) --雷光聚神茶
      ))then return true; end
    end
