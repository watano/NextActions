    ...
    if(W_TargetCanAttack()) then
      ...
      elseif(NA_ProfileNo == 1)then --Mistweaver
        ...
        if(not NA_IsAOE and (false
					...
					or NA_Fire(shs and NA_CountLowPlayers(NA_Target,0.7,30)>=4, '116680', NA_Player) --雷光聚神茶
					...
					or NA_Fire(shs and NA_isUsableTalentSpell(6,2) and NA_CountLowPlayers(NA_Target,0.7,30)>=4, '123904', NA_Target) --白虎下凡
      ...
      elseif(NA_ProfileNo == 2)then --Battledancer
        ...
        if(not NA_IsAOE and (false
					...
					or NA_Fire(NA_isUsableTalentSpell(6,2), '123904', NA_Target) --白虎下凡
					or NA_Fire((UnitPowerMax(NA_Player,12)-UnitPower(NA_Player,12))>=2 and ((NA_GetSpellCharges(115399)==1 and NA_GetSpellChargesTime(115399)<=10) or NA_GetSpellCharges(115399)==2) and W_BuffCount(NA_Player, 116740)<=16, '115399', NA_Player) --真气酒
    ...
    elseif(UnitCanAssist(NA_Player, NA_Target))then
      ...
      elseif(NA_ProfileNo == 1)then --Mistweaver
        ...
        if(false
					...
					or NA_Fire(lls and UnitPower(NA_Player, 12)>=3 and NA_CountLowPlayers(NA_Target,0.9,40)>=4, '116670', NA_Player) --振魂引
					...
					or NA_Fire(lls and NA_CountLowPlayers(NA_Player,0.9,8)>=4 and W_GetSpellCooldown(115151)>0 and W_GetSpellCooldown(115072)>0 and UnitPower(NA_Player, 12)<2, '101546', NA_Target) --神鹤引项踢
					...
					or NA_Fire(lls and NA_CountLowPlayers(NA_Target,0.9,30)>=4, '116680', NA_Player) --雷光聚神茶
					or NA_Fire(lls and NA_CountLowPlayers(NA_Target,0.9,30)>=4, '115460', NA_Player) --引爆真气
