function getNA10Actions(no)
  if(no < 0)then return {};
  elseif(no == 0)then
    return {'115080','119582','121253','115308','100784','100787','115098','115072','123904','119381','100780','115295','122278','115203','115176','116781'};
  elseif(no == 1)then
  ...
  elseif(no == 2)then
    return {'115080','100780','113656','115072','100787','115098','100784','116740'};
  end
  return {};
end
    ...
    if(W_TargetCanAttack()) then
      ...
      elseif(NA_ProfileNo == 2)then --Battledancer
        ...
        if(not NA_IsAOE and (false
					...
					or NA_Fire(NA_checkHP(2) or UnitPower(NA_Player, SPELL_POWER_CHI)<3, '115072', NA_Player) --移花接木
