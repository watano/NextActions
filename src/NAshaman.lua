...
local needHP3 = W_HPlevel(NA_Player) < 0.9 or (NA_IsSolo and not NA_IsMaxDps and W_HPlevel(NA_Player) < 0.9);
  ...
  if(W_IsInCombat())then
    ...
    --local qhsf = W_RetainBuff(NA_Player, 222222, true);   --强化释放
      ...
      or NA_Fire(true, '51505', NA_Target) --元素爆裂
    ...
    local hasxzxj = W_RetainBuff(NA_Player, 16188, true);   --先祖迅捷
      ...
      if(false
      or NA_Fire(not hasxzxj and W_HPlevel(NA_Target)<0.3, '16188', NA_Player) --先祖迅捷
      or NA_Fire(hasxzxj and W_HPlevel(NA_Target)<0.3, '8004', NA_Target) --先祖迅捷下的治疗之涌
      or NA_Fire(true, '5394', NA_Player) --治疗之泉图腾
      or NA_Fire(not ddzd, '379', NA_Target) --大地之盾
      or NA_Fire(not szhd, '52127', NA_Player) --水之护盾
      or NA_Fire(W_HPlevel(NA_Target)<0.7, '59547', NA_Target) --纳鲁的赐福
      or NA_Fire(not hassmsf and W_HPlevel(NA_Target)<0.9, '73685', NA_Player) --生命释放
      or NA_Fire(not hasjl and W_HPlevel(NA_Target)<0.9, '61295', NA_Target) --激流
or NA_Fire(hasjl and W_HPlevel(NA_Target)<0.7, '1064', NA_Target) --治疗链
or NA_Fire(hascxby and W_HPlevel(NA_Target)<0.6, '8004', NA_Target) --治疗之涌
or NA_Fire(W_HPlevel(NA_Target)<0.9, '77472', NA_Target) --治疗波
or NA_Fire(W_HPlevel(NA_Target)<0.6, '114049', NA_Player) --升腾
or NA_Fire(W_HPlevel(NA_Target)<0.6, '79206', NA_Player) --灵魂行者的恩赐
      )then return true; end
      return false;
