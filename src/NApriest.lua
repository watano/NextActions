  ...
  if(W_IsInCombat())then
    if(W_TargetCanAttack()) then
      ...
      elseif(NA_ProfileNo == 1)then --Holy
        ...
        if(not NA_IsAOE and (false
					or NA_Fire(NA_SpellInterrupt(NA_Target), '沉默', NA_Target) --沉默
					or NA_Fire(NA_CheckBuff(NA_Target)==1, '528', NA_Target) --驱散魔法
					or NA_Fire(NA_isUsableTalentSpell(3,2), '123040', NA_Target) --摧心魔
					or NA_Fire(not NA_isUsableTalentSpell(3,2), '34433', NA_Target) --暗影魔
					or NA_Fire(NA_isUsableTalentSpell(3,3), '129250', NA_Target) --真言术：慰
    ...
    elseif(UnitCanAssist(NA_Player, NA_Target))then
      ...
      elseif(NA_ProfileNo == 0)then --Discipline
        ...
        if(false
					...
					or NA_Fire(NA_CountLowPlayers(NA_Target,0.8,10)>=3 and tsz, '596', NA_Target) --治疗祷言
					or NA_Fire(NA_isUsableTalentSpell(6,3) and NA_CountLowPlayers(NA_Player,0.9,30)>=3, '120517', NA_Player) --光晕
					or NA_Fire(NA_isUsableTalentSpell(6,1) and NA_CountLowPlayers(NA_Target,0.8,30)>=3, '121135', NA_Target) --瀑流
					...
					or NA_Fire(NA_CountLowPlayers(NA_Player,0.8,12)>=3, '132157', NA_Player) --神圣新星
      ...
      elseif(NA_ProfileNo == 1)then --Holy
        ...
        if(false
					...
					or NA_Fire(NA_CountLowPlayers(NA_Target,0.8,30)>=3, '34861', NA_Target) --治疗之环
					or NA_Fire(W_HPlevel(NA_Target)<0.8 and mshc>0, '33076', NA_Target) --愈合祷言
					or NA_Fire(NA_isUsableTalentSpell(7,1) and NA_CountLowPlayers(NA_Target,0.8,30)>=3, '155245', NA_Target) --清晰使命
					or NA_Fire(not NA_isUsableTalentSpell(7,1) and NA_CountLowPlayers(NA_Target,0.8,30)>=3, '596', NA_Target) --治疗祷言
					or NA_Fire(NA_isUsableTalentSpell(7,3) and W_HPlevel(NA_Target)<0.7 and W_BuffCount(NA_Player, 152116)<=3, '152116', NA_Target) --救赎恩惠
					or NA_Fire(NA_isUsableTalentSpell(5,2) and W_HPlevel(NA_Target)<0.7, '10060', NA_Player) --能量灌注
					or NA_Fire(NA_isUsableTalentSpell(6,3) and NA_CountLowPlayers(NA_Player,0.9,30)>=3, '120517', NA_Player) --光晕
