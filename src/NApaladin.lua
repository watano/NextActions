  ...
  if(W_IsInCombat())then
    if(W_TargetCanAttack()) then
      ...
      elseif(NA_ProfileNo == 2)then --Holy
        ...
        if(not NA_IsAOE and (false
					or NA_Fire(NA_SpellInterrupt(NA_Target), '96231', NA_Target) --责难
					or NA_Fire(W_HPlevel(NA_Target)<0.2, '24275', NA_Target) --愤怒之锤
					or NA_Fire(NA_CheckTalent(3,1,activeSpec) and W_BuffCount(NA_Player, 85804)<3, '20271', NA_Target) --审判
					or NA_Fire(W_PaladinPower(NA_Player)<=3, '20473', NA_Target) --神圣震击
					or NA_Fire(W_PaladinPower(NA_Player)<3, '20271', NA_Target) --审判
					or NA_Fire(NA_CheckTalent(2,1,activeSpec) and NA_SpellInterrupt(NA_Target), '105593', NA_Target) --制裁之拳
					or NA_Fire(not NA_CheckTalent(2,1,activeSpec) and NA_SpellInterrupt(NA_Target), '853', NA_Target) --制裁之锤
    ...
    elseif(UnitCanAssist(NA_Player, NA_Target) and UnitIsPlayer(NA_Target))then
      ...
      elseif(NA_ProfileNo == 0)then --Protection
        ...
        if(false
					or NA_Fire(NA_CheckDebuff(NA_Player)==2 or NA_CheckDebuff(NA_Player)==3, '4987', NA_Player) --清洁术
					or NA_Fire(W_HPlevel(NA_Target)<0.6 and W_HPlevel(NA_Player)>0.7 and not UnitIsUnit(NA_Player,NA_Target), '6940', NA_Target) --牺牲之手
					or NA_Fire(NA_CheckRoles(NA_Target)~=1 and W_HPlevel(NA_Target) < 0.6 and not UnitIsUnit(NA_Player,NA_Target), '1022', NA_Target) --保护之手
      ...
      elseif(NA_ProfileNo == 2)then --Holy
        ...
        if(false
					...
					or NA_Fire(NA_CheckGlyph(1068) and W_HPlevel(NA_Target) < 0.4 and not UnitIsUnit(NA_Player,NA_Target), '6940', NA_Target) --牺牲之手
					or NA_Fire(not NA_CheckGlyph(1068) and W_HPlevel(NA_Target) < 0.4 and W_HPlevel(NA_Player)>0.7 and not UnitIsUnit(NA_Player,NA_Target), '6940', NA_Target) --牺牲之手
					or NA_Fire(NA_CheckRoles(NA_Target)~=1 and W_HPlevel(NA_Target)<0.6 and not UnitIsUnit(NA_Player,NA_Target), '1022', NA_Target) --保护之手
					...
					or NA_Fire(NA_CheckTalent(3,2,activeSpec) and not hastorch_thrown and W_PaladinPower(NA_Player)>=3 and W_HPlevel(NA_Target)<0.9, '114163', NA_Target) --永恒之火
					or NA_Fire(not NA_CheckTalent(3,2,activeSpec) and W_PaladinPower(NA_Player)>=3 and W_HPlevel(NA_Target) < 0.9, '85673', NA_Target) --荣耀圣令
					...
					or NA_Fire(NA_CheckTalent(6,1,activeSpec) and W_HPlevel(NA_Target) < 0.9, '114165', NA_Target) --神圣棱镜
    ...
    elseif(NA_ProfileNo == 0)then --Protection
      ...
      if(false
					...
					or NA_Fire(not W_HasBuff(NA_Player, 20217, true) and not W_HasBuff(NA_Player, 1126, true), '20217', NA_Player) --王者祝福
					or NA_Fire((W_BuffCount(NA_Player, 20217)~=1 and W_HasBuff(NA_Player, 20217, true) or W_HasBuff(NA_Player, 1126, true)) and not W_HasBuff(NA_Player, 19740, true), '19740', NA_Player) --力量祝福
