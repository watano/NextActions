...
or NA_Fire(NA_ProfileNo == 0 and needHP2, '108293', NA_Player) --野性之心
or NA_Fire(NA_ProfileNo == 0 and needHP2 and yxhc, '774', NA_Player) --野性之心下的回春
...
or NA_Fire(true, '50334', NA_Player) --狂暴
...
or NA_Fire(UnitPower(NA_Player,8) > 0, '102560', NA_Player) --化身
or NA_Fire(W_BuffTime(NA_Target,-164815) < 7 or rzd, '93402', NA_Target) --阳炎术
